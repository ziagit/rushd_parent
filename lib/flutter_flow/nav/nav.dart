...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Porfile',
          path: '/porfile',
          builder: (context, params) => const PorfileWidget(),
        ),
        FFRoute(
          name: 'Login',
          path: '/login',
        ...
        FFRoute(
          name: 'VerifiationCode',
          path: '/verifiationCode',
          builder: (context, params) => const VerifiationCodeWidget(),
        ),
        FFRoute(
          name: 'NewPassword',
          path: '/newPassword',
        ...
        FFRoute(
          ...
          path: '/children',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Children')
        ...
        FFRoute(
          name: 'GenralInformation',
          path: '/genralInformation',
          builder: (context, params) => const GenralInformationWidget(),
        ),
        FFRoute(
          name: 'ResetPassword',
          path: '/resetPassword',
        ...
        FFRoute(
          ...
          path: '/childrenClasses',
          builder: (context, params) => const ChildrenClassesWidget(),
        ),
        FFRoute(
          name: 'ChildrenCourses',
          path: '/childrenCourses',
          builder: (context, params) => const ChildrenCoursesWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'ReviewHomework',
          path: '/reviewHomework',
          builder: (context, params) => const ReviewHomeworkWidget(),
        ),
        FFRoute(
          name: 'EditContact',
          path: '/editContact',
